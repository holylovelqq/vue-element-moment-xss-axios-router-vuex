...
<template>
  <div class="incidents">
    ...
    <!-- table component -->
    <data-table :tableData="incidents" :tableColums="colums" :clickFn="goIncidentDetail" :pageSize="pageSize" :totalNum="totalNum" :currentPage="currentIndex" :currentChange="currentChange" :pageSizeChange="pageSizeChange" :prevClick="prevClick" :nextClick="nextClick"></data-table>
  </div>
</template>
...
export default{
  ...
  methods: {
    ...
    goIncidentDetail (row, column, cell, event) {
      // console.log(row)
      // console.log(column)
      // console.log(cell)
      // console.log(event)
